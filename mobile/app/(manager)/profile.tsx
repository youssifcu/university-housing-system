      ...
      try {
        ...
        if (response.ok && data.user) {
          ...
          if (data.user.profilePicture) {
            ...
            setImageBase64(data.user.profilePicture);
          }
        }
      } catch (error) {
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.userNameText}>{managerInfo?.name || 'Manager'}</Text>
          <Text style={styles.roleText}>Manager Account</Text>
        </View>
        ...
        <View style={styles.section}>
          <Text style={styles.sectionTitle}>Manager Info</Text>
          <View style={styles.readOnlyCard}>
            <ReadOnlyItem icon="shield-account-outline" label="Role" value={managerInfo?.role || 'Manager'} />
            <ReadOnlyItem icon="office-building-outline" label="Department" value={managerInfo?.department || 'N/A'} />
            <ReadOnlyItem icon="phone-outline" label="Phone" value={managerInfo?.phoneNumber || 'N/A'} />
          </View>
        </View>
