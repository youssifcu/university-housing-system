          ...
          <View style={styles.section}>
            ...
            <View style={styles.toggle}>
              ...
              <Switch
                ...
                onValueChange={v => updateField("hasSpecialNeeds", v)}
          ...
          <View style={styles.section}>
            ...
            {[
              ...
              <TouchableOpacity
                key={key}
                style={styles.file}
                onPress={() => isImage ? pickImage(key) : pickDoc(key)}
              >
                <MaterialCommunityIcons
                  name={files[key] ? "check-circle" : icon}
                  size={22}
                  color={files[key] ? COLORS.SUCCESS : COLORS.PRIMARY}
                />
...
const styles = StyleSheet.create({
  ...
  scroll: { padding: 16 },
  title: { fontSize: 24, fontWeight: "900", textAlign: "center", marginBottom: 20, color: COLORS.PRIMARY },
